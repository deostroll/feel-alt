...
name = name_start (name_part / additional_name_symbols)* & { return options.helper.nameResolver.isValidName(text()) } { return options.helper.resolveName(text()) }
...
additional_name_symbols =
  "." { options.helper.nameResolver.pushSymbol(text()) }
  /
  "/" { options.helper.nameResolver.pushSymbol(text()) }
  /
  "-" { options.helper.nameResolver.pushSymbol(text()) }
