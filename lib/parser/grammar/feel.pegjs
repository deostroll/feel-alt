...
path_expression = !{ options.helper.nameResolver.enter(NameResolver.MODE_PATH_EXP) } (a:name { return scopePathExpressionVariable(a) }) DOT b:path_expression { console.log('a:', a, 'b:', b) };
