...
path_expression = !{ options.helper.nameResolver.enter(NameResolver.MODE_PATH_EXP) } (a:name { return scopePathExpressionVariable(a) }) DOT b:( _defaulted_name_ / d:path_expression { return d }) { console.log('..a:', a, 'b:', b) };
