...
textual_expression = function_invocation 
  / path_expression
  / name
  / literal;
...
function_invocation = fn:_function_invocation_expression_ params:parameters { return { type: 'function invocation', fn, params } };
...
parameters = "(" params:(named_parameters/positional_parameters) ")" { return exit$parameters(params); } ;
...
positional_parameters = params:(expression ("," expression)*)* { return exit$positional_parameters(params)};
