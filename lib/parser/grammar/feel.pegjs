...
path_expression = !{ pushMode(NameResolver.MODE_PATH_EXP) } head:(a:name { return scopePathExpressionVariable(a) }) DOT b:(c:(_defaulted_name_ {return c})/ d:(_child_path_exp_ {return d} ) ) { popMode(); console.log('..a:', head, '..b:', b) };
...
_child_path_exp_ = !{ popMode(); } a:path_expression { return a;};