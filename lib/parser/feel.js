...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c42 = function(fn, params) { return { type: 'function invocation', fn, params } },
      peg$c43 = "(",
      peg$c44 = peg$literalExpectation("(", false),
      peg$c45 = ")",
      peg$c46 = peg$literalExpectation(")", false),
      peg$c47 = function(head, sym) { return test$additional_name_symbols(sym) },
      peg$c48 = function(head, tail) { return test$name(head, tail) },
      peg$c49 = function(head, tail) { return exit$name(head, tail) },
      peg$c50 = "?",
      ...
      peg$c88 = function(params) { return exit$parameters(params); },
      peg$c89 = ":",
      peg$c90 = peg$literalExpectation(":", false),
      peg$c91 = ",",
      peg$c92 = peg$literalExpectation(",", false),
      peg$c93 = function(params) { return exit$positional_parameters(params)},
      peg$c94 = function() { enter$path_expression() },
      peg$c95 = function(a) { return scopePathExpressionVariable(a) },
      peg$c96 = function(head, tail) { return exit$path_expression(head, tail); },
      peg$c97 = "/",
      ...
      peg$c105 = function() { enter$_defaulted_name_() },
      peg$c106 = function(a) { return exit$_defaulted_name_(a) },
      peg$c107 = function() { enter$_child_path_exp_() },
      peg$c108 = function(k) { return exit$_child_path_exp_(k); },
  ...
  function peg$parsepositional_parameters() {
    ...
    s1 = [];
    s2 = peg$currPos;
    s3 = peg$parsetextual_expression();
    if (s3 !== peg$FAILED) {
      s4 = [];
      s5 = peg$currPos;
      ...
      if (s6 !== peg$FAILED) {
        s7 = peg$parsetextual_expression();
        if (s7 !== peg$FAILED) {
          s6 = [s6, s7];
          s5 = s6;
        } else {
  ...
  function peg$parsepath_expression() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parseDOT();
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_defaulted_name_();
          if (s4 === peg$FAILED) {
            s4 = peg$parse_child_path_exp_();
          }
          if (s4 !== peg$FAILED) {
            peg$savedPos = s0;
            s1 = peg$c96(s2, s4);
  ...
  function peg$parse_defaulted_name_() {
    var s0, s1, s2,
        startPos = peg$currPos;

    peg$tracer.trace({
      type:     "rule.enter",
      rule:     "_defaulted_name_",
      location: peg$computeLocation(startPos, startPos)
    });
  ...
  function peg$parse_child_path_exp_() {
    var s0, s1, s2,
        startPos = peg$currPos;

    peg$tracer.trace({
      type:     "rule.enter",
      rule:     "_child_path_exp_",
      location: peg$computeLocation(startPos, startPos)
    });
